...
// spanning multiple invoices (see the multi-invoice settlement feature) shows every invoice
// number it was applied to, comma-joined, rather than splitting into multiple rows.
  ...
  return (
    <div>
      <div className="border-b border-gray-200 bg-white px-6 py-4">
        ...
        <h1 className="text-lg font-semibold text-ink-800">Payments Received</h1>
